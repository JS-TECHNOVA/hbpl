			...
			<section className="py-16 bg-gradient-to-r from-background via-muted/40 to-background">
				<div className="container mx-auto px-4 text-center">
					...
					<p className="text-muted-foreground mb-8">
						{tr(
							"125 days left in tournament! Get ready for the ultimate showdown!",
							"टूर्नामेंट में 125 दिन बाकी! शानदार मुकाबले के लिए तैयार हो जाइए!",
							language,
						)}
					</p>
				...
				<div className="container mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-6">
						{[
							{
								step: "01",
								title: { en: "Register", hi: "रजिस्टर करें" },
								text: {
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div className="bg-card border border-border rounded-xl p-5 shadow-sm flex gap-3 items-start">
							...
							<div>
								...
								<p className="text-xs text-muted-foreground">
									Open to students from Class 5 to 10 across
									Harpur Belahi and nearby areas.
								</p>
							</div>
						</div>
						...
						<div className="bg-card border border-border rounded-xl p-5 shadow-sm flex gap-3 items-start">
							...
							<div>
								...
								<p className="text-xs text-muted-foreground">
									90 minutes, 90 marks, multi-subject
									objective paper with no negative marking.
								</p>
							</div>
						</div>
						...
						<div className="bg-card border border-border rounded-xl p-5 shadow-sm flex gap-3 items-start sm:col-span-2">
							...
							<div>
								...
								<p className="text-xs text-muted-foreground">
									Toppers are featured on the HBPL Exam Portal
									with medals, certificates, and public
									felicitation.
								</p>
							</div>
						</div>
				...
				>
					<h2 className="text-3xl md:text-4xl font-bold mb-4">
						{tr(
							...
							"क्या आप जुड़ने के लिए तैयार हैं?",
							language,
						)}
					</h2>
